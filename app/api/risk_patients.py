...
risk_patients_bp = Blueprint('risk_patients', __name__)

@risk_patients_bp.route('/risk-patients', methods=['GET'])
def get_risk_patients():
    ...
    try:
        ...
        if location:
            query = query.filter_by(zip_code=location)
...
@risk_patients_bp.route('/risk-patients/<int:patient_id>', methods=['GET'])
def get_patient_risk_details(patient_id):
    ...
    try:
        ...
        risk_history = RiskAssessment.query.filter_by(
...
@risk_patients_bp.route('/risk-patients/summary', methods=['GET'])
...
@risk_patients_bp.route('/risk-patients/<int:patient_id>/comprehensive', methods=['GET'])
